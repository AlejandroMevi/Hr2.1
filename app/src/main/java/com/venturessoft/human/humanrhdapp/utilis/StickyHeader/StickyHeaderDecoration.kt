...
import com.venturessoft.human.humanrhdapp.databinding.ViewStickyHeaderBinding
import com.venturessoft.human.humanrhdapp.ui.home.ui.fragments.timeManagement.generalInformation.ui.GeneralInformationAgrupedAdaper

class StickyHeaderDecoration(private val adapter: GeneralInformationAgrupedAdaper, root: View) : ItemDecoration() {
    ...
    private fun calculateHeaderTop(topView: View?, secondChild: View?): Float = secondChild?.let { secondView ->
        val threshold = getPixels(0, headerBinding.root.context) + headerView.bottom
