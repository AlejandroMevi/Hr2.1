...
import com.venturessoft.human.humanrhdapp.databinding.ListItemEstacionesLibresBinding
...
class EstacionesLibresAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderGeneral<*> {
        val itemBinding = ListItemEstacionesLibresBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ViewHolder(
        ...
        override fun bind(item: EstacionesEmpItem) {
            ...
            binding.date.text = "${item.fechaChecada} ${context.getString(R.string.a_las)} ${item.horaChecada} "
